...
<body>
			...
			<form id="form1">
				...
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon4">Proveedor a buscar</span> <input
						...
						aria-describedby="basic-addon4" required id="proveesearch" >
				</div>
				<br>
				<br>
				<br>
	...
	<script>
		function enviar() {
				...
				var provee=   document.getElementById("proveesearch").value;
				req.open('GET', 'http://localhost:8080/consultarproveedor?proveedor='+provee, false);
				req.send(null);
				var proveedor = null;
				if (req.status == 200)
			...
			if (proveedor.toString()!=""){
				...
				document.getElementById("nombre_proveedor").value = proveedor[0].nit_proveedor;
				...
				document.getElementById("proveesearch").value = "";
