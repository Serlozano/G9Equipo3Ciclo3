...
public class ProveedorDAO {
	...
	public void registrarProveedor(ProveedorVO provee) {
		...
		try {
			...
			String sentencia = "INSERT INTO proveedores VALUES(" 
					+ provee.getNit_proveedor() + "," + "'"
					+ provee.getCiudad_proveedor() + "'," + "'" 
					+ provee.getNombre_proveedor() + "'," + "'" 
					+ provee.getDireccion_proveedor()+ "'," + "'" 
					+ provee.getTelefono_proveedor() + "'" 
					+ ");";
	...
	/**
	 * permite consultar el Proveedor asociado al clien enviado como parametro
	 * 
	 * @param documento
	 * @return
	 */
	...
	public void actualizarProveedor(ProveedorVO provee) {
		...
		try {
			...
			String sentencia = "UPDATE proveedores "
					+ "SET nombre_proveedor = '"+provee.getNombre_proveedor()+"',"
